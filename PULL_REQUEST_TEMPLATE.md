Please check if what you want to add to `go-opera` list meets [quality standards](https://github.com/millicentnetwork/go-opera/blob/master/CONTRIBUTING.md#quality-standard) before sending pull request.
